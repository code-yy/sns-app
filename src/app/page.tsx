import { details, footer, git, link } from './styles.css';
    ...
    <>
      ...
      <footer className={footer}>
        <div className={details}>
          <p>
            Built with{' '}
            <a className={link} target="_blank" href="https://nextjs.org" rel="noreferrer">
              Next.js
            </a>{' '}
            and{' '}
            <a className={link} target="_blank" href="https://vanilla-extract.style/" rel="noreferrer">
              Vanilla Extract
            </a>{' '}
          </p>
        </div>
        <a target="_blank" href="https://github.com/SuttonJack/vanilla-extract-app-dir" className={git}>
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
